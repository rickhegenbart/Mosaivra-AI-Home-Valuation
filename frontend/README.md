...
The model predicts an **Estimated Public Parcel Value** using 25 features derived from public parcel records and government economic sources:

```text
Parcel size
Latitude/longitude
Tax year
FHFA Housing Price Index indicators
FRED mortgage-rate indicators
FRED unemployment indicators
