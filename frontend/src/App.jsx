    ...
    <main className="page">
      <section className="hero">
        ...
        <section className="methodologyBox">
          <div>
            <h2>How Mosaivra AI Works</h2>
            <p>
              Mosaivra AI transforms scattered public property, market, and
          ...
          <p className="methodologyDisclaimer">
            ...
            by property type. Mosaivra AI is not an appraisal, CMA, MLS valuation,
...
<section id="details-section" className="card">
            ...
            <div className="scenarioExplainer">
              ...
              <p>
                Mosaivra AI first generates a baseline estimate from the trained model.
                When you enter property details below, the app applies a transparent
                adjustment layer to that baseline estimate.
              </p>
              <ul>
                <li>
                  <strong>Baseline Estimate:</strong> Generated by the trained Mosaivra AI model.
                </li>
                <li>
          ...
          {adjustedScenario && (
            <section id="scenario-section" className="card adjustmentCard">
              ...
              {(adjustedScenario.hasPhotos || adjustedScenario.hasMlsNotes) && (
                <div className="notes">
                  ...
                  {adjustedScenario.hasPhotos && (
                    <p>
                      Photos were selected, but Mosaivra AI does not currently
              ...
              <p className="disclaimer">
                ...
                layer applied to the baseline Mosaivra AI estimate using
...
function AdminDashboard() {
  const [token, setToken] = useState(() => sessionStorage.getItem("mosaivraAdminToken") || "");
  ...
  function saveToken() {
    sessionStorage.setItem("mosaivraAdminToken", token);
    setStatus("Admin token saved for this browser session.");
  }

  function clearToken() {
    sessionStorage.removeItem("mosaivraAdminToken");
    setToken("");
    setSummary([]);
    setFeedback([]);
  ...
  return (
    <main className="page adminPage">
      <section className="hero adminHero">
        ...
        <p className="subtitle">
          Review Mosaivra AI estimate feedback submitted by testers.
        </p>

        <div className="adminActions">
          <a href="/" className="adminBackLink">← Back to Mosaivra AI</a>
        </div>
      </section>
